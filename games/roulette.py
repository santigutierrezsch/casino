    ...
    if bet_type == 1:  # Inside Bets
        ...
        if inside_choice == 1:  # Straight
            ...
            while True:
                try:
                    ...
                    if row_start in range(1, 35, 3):
                        break
                    else:
                        print("Invalid starting number. Please enter 1, 4, 7, ..., 34.")
                except ValueError:
            ...
            if advanced_choice == 1:  # Basket
                ...
                six_line_numbers = [str(row_start + i) for i in range(6)]
                if spin_result in six_line_numbers:
                    winnings = bet * 5
                    print(f"The wheel spun... Result: {spin_result} ({spin_color}).")
                    print(f"You guessed correctly! You win ${winnings:.2f}.")
                    player.add_balance(winnings)
        ...
        if outside_choice == 1:  # Red/Black
            ...
            if spin_result in ['0', '00']:
                print(f"The wheel spun... Result: {spin_result} ({spin_color}).")
                print("The result was green. You lose.")
            elif spin_color == chosen_color:
                winnings = bet * 2
                print(f"The wheel spun... Result: {spin_result} ({spin_color}).")
                print(f"You guessed correctly! You win ${winnings:.2f}.")
                player.add_balance(winnings)
        ...
        elif outside_choice == 2:  # Odd/Even
            while True:
                chosen_odd_even = input("Enter 'odd' or 'even': ").strip().lower()
                if chosen_odd_even in ['odd', 'even']:
                    break
                else:
            ...
            elif (int(spin_result) % 2 == 0 and chosen_odd_even == 'even') or \
                 (int(spin_result) % 2 != 0 and chosen_odd_even == 'odd'):
                winnings = bet * 2
                print(f"The wheel spun... Result: {spin_result} ({spin_color}).")
                print(f"You guessed correctly! You win ${winnings:.2f}.")
                player.add_balance(winnings)
            ...
            if spin_result in ['0', '00']:
                print(f"The wheel spun... Result: {spin_result} ({spin_color}).")
                print("The result was not in any column. You lose.")
            elif spin_result in columns[chosen_column]:
                winnings = bet * 3
                print(f"The wheel spun... Result: {spin_result} ({spin_color}).")
                print(f"You guessed correctly! You win ${winnings:.2f}.")
                player.add_balance(winnings)
